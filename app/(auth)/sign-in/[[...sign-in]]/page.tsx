          ...
          <section className="relative flex h-32 items-end bg-dark lg:col-span-5 lg:h-full xl:col-span-6">
            ...
            <div className="hidden lg:relative lg:block lg:p-12">
              ...
              <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
                Welcome Back to PDFind 👋🏻
              </h2>

              <p className="mt-4 leading-relaxed text-white/90">
                Welcome back to PDFind! Transform your PDFs into insightful
                notes with ease. Sign in to continue enhancing your productivity
                with AI assistance.
              </p>
            </div>
          </section>
            ...
            <div className="max-w-xl lg:max-w-3xl">
              <div className="relative -mt-16 block lg:hidden mb-5">
                ...
                <p className="mt-4 leading-relaxed text-gray-400">
                  Welcome back to PDFind! Transform your PDFs into insightful
                  notes with ease. Sign in to continue enhancing your
